...
export default function Navbar({
    ...
    const handleClick = async () => {
        ...
        try {
            ...
            setShowAlert(true);
            setAlertMessage('token was copied to clipboard');
        } catch (err) {
    ...
    return (
        <div>
                ...
                <div className="ms-auto d-flex gap-2">
                    ...
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li><a className={"dropdown-item"} href={`/connect/${process.env.REACT_APP_SF_FORM_ID}`}>Add
                                Salesforce</a>
                            </li>
                            <button className={"btn ms-1"}
                                    onClick={handleClick}>Get Token
                            </button>
                            <button className="btn ms-1"
            ...
            <div className="container">
                {showAlert && (
                    <div className="alert alert-success mt-lg-5" role="alert">
                        {alertMessage}
                    </div>
                )}
            </div>
